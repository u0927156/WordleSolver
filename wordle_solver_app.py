...
def main():
    ...
    for iter in range(6):
        ...
        while True:
            try:
                result_of_guess = input(
                    "Enter result as a five letter string, where G is green, Y is yellow, and X is Grey: "
                )
        ...
        words = wordle_utils.eliminate_words_based_on_guess(
            guess, result_of_guess, words
        )
